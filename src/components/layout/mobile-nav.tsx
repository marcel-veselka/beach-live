...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border/40 bg-card/98 backdrop-blur-xl supports-[backdrop-filter]:bg-card/85 safe-area-bottom md:hidden">
